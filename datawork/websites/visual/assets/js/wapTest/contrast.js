...
$.fn.contrast = function(options){
	...
	function visualChange(){
		...
		$contrastPanel.closest('.panel').toggleClass('contrast-flod').toggleClass('contrast-show');
	...
	function getHover(obj){
		...
		if(opts.type =='easyui'){
			obj.hover(function(e){
				...
				$div.find(".data_name").css({"height":"30px","line-height":"30px","overflow":"hidden","display":"block"})
