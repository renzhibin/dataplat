function createNewElement(configData, tableObj){
 	 var html ='<div class="row web-filter-content" style="margin:0px;background-color:#eee;padding:5px 0px 2px 10px;">';
 		  ...
 		  switch(configData[i].type){
			...
			case 'input':
  				...
  				if( configData[i].is_accurate  !=undefined && configData[i].is_accurate  ==1 ){
  					...
  					html +="<span style='color:#0c8f44'>"+configData[i].title+"：</span>";
  				}else{
