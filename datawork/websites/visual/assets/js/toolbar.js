...
ToolBar.prototype = {
    ...
    initData: function (params) {
        if (typeof(params) == "undefined" || !params.timereport) {
            return false
        }
            ...
            buttons: [{
                ...
                handler: function () {
                    ...
                    if (type == 1) {
                            ...
                            if ($checkbox.eq(i).is(":checked")) {
                                ...
                                if (dataval != '') {
                                    var datajson = JSON.parse(decodeURIComponent(dataval)),
                                        customkeydata = {};
                                    if (typeof datajson.grade == "undefined") {
                                        var gradedata = {};
                                    } else {
                                        var gradedata = datajson.grade.data;
                                    }
                                    //获取本地保存的自定义 显示隐藏的数据
                        ...
                        $form.find('input[name="downConfig"]').val(encodeURIComponent(JSON.stringify(dataArray)));
                        $form.submit();
                    }
