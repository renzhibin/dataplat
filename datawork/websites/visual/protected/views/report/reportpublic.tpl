    ...
    <table class='table table-condensed table-bordered'>
        ...
        <tr>
            ...
            <td>
                ...
                <input class="easyui-numberspinner refresh_time_box" name="refresh_time" value="5" data-options="min:1,increment:1,max:60" style="width:50px;"/>&nbsp;&nbsp;分钟
            </td>
        </tr>
        <tr>
    ...
    <table class='table table-condensed table-bordered'>
        ...
        <tr class='single'>
            ...
            <td>
                <div class="btn-group single_shortcut" role="group">
                    <button type="button" class="btn btn-sm btn-default" data-option='1' style="color: black;">昨天</button>
                    <button type="button" class="btn btn-sm btn-default" data-option='2' style="color: black;">前天</button>
                </div>
        ...
        <tr class='single'>
            ...
            <td>
                ...
                <a href="javascript:void(0)" class="btn btn-default btn-sm" onclick="setvalue(this)">自定义时间(间隔以时间粒度为单位!)</a>
            </td>
        </tr>
        <tr class='interval' style='display:none'>
            ...
            <td>
                <div class="btn-group interval_shortcut" role="group">
                    <button type="button" class="btn btn-sm btn-default" data-option='7' style="color: black;">最近7天</button>
                    <button type="button" class="btn btn-sm btn-default" data-option='30' style="color: black;">最近30天</button>
                </div>
                <span class='tipinfoother'>(点击可选多天!)</span>
            </td>
        </tr>
...
<div id="chartreport" style='display:none'>
    <table class="table table-bordered table-condensed tbHeader"
        ...
        <tr class="xAxis_time_box" style="display: none;">
            <td style='width:100px;text-align:right'>x轴补全:</td>
            <td>
                <select class='select' name='xAxisTime' style="width:200px">
                    <option value='filter_not' selected='selected'>----</option>
                ...
                <span class='tipinfoother'>将天按照所选时间间隔进行拆分</span>
            </td>
        </tr>
        ...
        <tr class="chart_event">
            ...
            <td>
                <select name='chart_event_checkbox' style="width:200px">
        ...
        <tr class="chart_data_source">
            ...
            <td>
                ...
                <button class='btn btn-default btn-sm' data-option='dataSource'>选择数据源</button>
                 -->
                <button class='btn btn-default btn-sm' data-option='dataSource'>普通图表</button>
                <button class='btn btn-default btn-sm' data-option='customSource'>自定义图表</button>
                <!--数据框-->
