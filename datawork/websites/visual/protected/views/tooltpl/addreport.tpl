...
<div>
  {/include file="layouts/menu.tpl"/}
   <div id='right'>
		 <!-- style='background-color:#fff;position:realtive;min-height:630px' -->
   	<div id="content" class="content content-top" style='background-color:#fff;position:realtive;min-height:630px'>
