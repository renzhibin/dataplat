...
<div id="right">
        ...
        <div id="content" class="container-filter">
            <!--面包屑效果-->
            ...
            <div class="function-buttions">
                <a class="add-item btn btn-primary" data-toggle="modal" data-target="#myModal">新增外链</a>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table  table-hover">
                        ...
                        <tr>
                            ...
                            <th class="col-md-2">外链名称</th>
                            <th class="col-md-3">外链url</th>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">外链管理</h4>
      </div>
...
<script src="/assets/js/tool/openurlmanage.js?version={/$version/}"></script>
