                        ...
                        <form id='fm' method='post'>
                            <table class='table table-condensed table-bordered' style='margin-bottom:5px'>
                                ...
                                <tr class='secondMenu'>
                                    ...
                                    <td>
                                        <input type='text' name='second_menu' class='inputall'/>
                                        <br/>
                                        <span class='tipinfo'>注意：报表名必须是中英文、数字、小括号或者下划线且不超过15个字符！
                                    </td>
                                </tr>
                                <!-- <tr>
                                ...
                                <tr class='openUrl'>
                                    ...
                                    <td>
                                        <textarea  name='url'  style='width:350px;height:100px' class="inputall"  placeholder="名称:url的格式，以回车分隔"></textarea>
                                        <br/>
                                        <span class='tipinfo'>注意：URL必须是完整链接，例如：http://www.baidu.com</span>
                                    </td>
                                </tr>
                            </table>
                            <span style='padding-left:30%'></span>
                            <input type='hidden' value='' name='menu_id'/> 
                            <input type='hidden' value='' name='old_report_id'/>
