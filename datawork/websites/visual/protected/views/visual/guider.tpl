...
<div id='right'>
    <div id="content" class="content content-top" >
        <!--面包屑效果-->
        ...
        {/if $isauth eq 'true'/}
        <span style="float:right; margin-right: 100px; margin-top: 20px;"><a href="/visual/toolguiderlist" class="btn btn-primary btn-xs" style="font-size: 14px;">编辑</a></span>
        {//if/}
        {/foreach from = $menu item= menu_i key=key/}
        <div class="title" style="margin-top: 30px; margin-left: 20px">{/$menu_i.name/}</div>
        <hr class="hr"/>
        <div>
