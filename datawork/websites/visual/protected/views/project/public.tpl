        ...
        <tr class="storetypebox" style="display:none">
            ...
            <td>
                <select name="hql_type" class="hql_type">
                    <option value="1">报表类</option>
                    {/if $is_edit == true/}
                    <option value="2">调度类</option>
                    {//if/}
                </select>
            </td>
        </tr>
...
set mapred.reduce.tasks=10; "></textarea>
        ...
        {/if $is_edit == true/}
        <div>
            <a class="btn btn-primary btn-his-version" id="btn-his-version" role="button" data-toggle="collapse" href="#collapseVersion" aria-expanded="false" aria-controls="collapseVersion">
                点击查看最近12个版本
            </a>
            <div class="collapse" id="collapseVersion">
                <div class="well" style="padding: 0;">
                    <div class="row">暂无相关历史版本</div>
                </div>
            </div>
        </div>

        <div class="modal fade" id="his_version" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                        <h4 class="modal-title version_id"></h4>
                    </div>
                    <div class="modal-body">
                        <h4>当前版本修改人</h4>
                        <p class="version_user"></p>
                        <h4>当前版本修改时间</h4>
                        <p class="version_date"></p>
                        <hr>
                        <h4>当前版本HQL</h4>
                        <div id="editorcodeversion"></div>
                    </div>
