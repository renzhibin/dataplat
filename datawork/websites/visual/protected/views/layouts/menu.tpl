            ...
            <ul>
                ...
                <li {/if $menu_id eq $menuinfo.menu_id/} class='active' {/$first_menu = $key/}  {/$second_menu = $menuinfo.name/} {//if/}>
                    ...
                    <ul class="three-tab hide" style="position: fixed;top: 41px;left: 4.1rem;height:100%;overflow:scroll;padding-bottom:45px" data-id="{/$menuinfo.menu_id/}">
                        ...
                        <!--三级正常 -->
                        <li  class=''>
                            <a href="/visual/index/menu_id/{/$menuinfo.menu_id/}/id/{/$table.id/}" style="color:#404040 !important;" data-id="{/$table.id/}">{/$table.cn_name/}
                                {/if $table.type eq 3/}
                        ...
                        <!--三级外链 电脑上不显示web-three-tab-->
                        <li  class='web-three-tab'>
                            <a  data-option="{/$table.url/}" class="openurl ygcp" style="color:#404040 !important;" data-id="{/$menuinfo.menu_id/}" data-type="{/$table.type/}"> {/$table.name/} <span class=" glyphicon glyphicon-globe"></span></a>
                        </li>
                        {//if/}
                        {//foreach/}
                    </ul>
                    ...
                    <ul class="three-tab web-three-tab hide" style="position: fixed;top: 41px;left: 4.1rem;height:100%;overflow:scroll;padding-bottom:45px" data-id="{/$menuinfo.menu_id/}">
                        ...
                        <!--三级正常 -->
                        <li  class=''>
                            <a href="/visual/index/menu_id/{/$menuinfo.menu_id/}/id/{/$table.id/}" style="color:#404040 !important;" data-id="{/$table.id/}">{/$table.cn_name/}</a>
                        </li>
                        {/else if $table.type eq 3/}
                        <li  class=''>
                            <a data-option="{/$table.url/}" href="/visual/index/menu_id/{/$menuinfo.menu_id/}/id/{/$table.id/}" style="color:#404040 !important;" data-id="{/$table.id/}">{/$table.cn_name/}<span class=" glyphicon glyphicon-globe"></span></a>
                        </li>
                        {/else/}
                        <!--三级外链 -->
                        <li  class=''>
                            <a  data-option="{/$table.url/}" class="openurl ygcp" data-id="{/$menuinfo.menu_id/}" style="color:#404040 !important;" data-type="{/$table.type/}"> {/$table.name/} <span class=" glyphicon glyphicon-globe"></span></a>
                        </li>
                        {//if/}
                        {//foreach/}
                    </ul>
...
<div id="menu_hidden" class="max-show web-breadcrumbs">
    {/if $first_menu/}
