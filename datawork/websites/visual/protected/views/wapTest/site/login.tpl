...
<html lang="en">
    <head>
        <title>趣店数据分析平台</title><meta charset="UTF-8" />
    ...
    <body>
        ...
        <div id="loginbox">
            <form id="loginform" method="post" class="form-vertical" action="/site/login">
                <div class="control-group normal_text"> <h1>趣店数据分析平台</h1></div>
                        ...
                        <div class="main_input_box">
                            <div class='main_cont'>
                                <span class="pull-left">
                                    <!--
                                    <a class="flip-link btn btn-info" href="mailto:pengbangzhong@lsh123.com?subject=忘记密码了">忘记密码?</a>
                                    -->
                                </span>
