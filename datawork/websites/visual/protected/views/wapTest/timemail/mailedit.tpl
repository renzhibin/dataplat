            ...
            <form id='fm' method='post'>
              <table class='table table-condensed table-bordered' style='margin-bottom:5px'>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="addressee" style="width: 300px; height: 100px" >{/$addressee/}</textarea><br>
               ...
               <!--  <tr>
                ...
                <tr>
                  ...
                  <tr>
                      <td style='text-align:right;width:30%'>最迟报警时间（天级）<b style='color:red'>*</b></td>
                      <td>
                          <span>时:</span>
                          ...
                          <select style="width: 80px" name="minute">
                              <option value="{/$time_m/}" selected="selected">{/$time_m/}</option>
                              <option value="00">00</option>
                              <option value="01">01</option>
                              <option value="02">02</option>
                              <option value="03">03</option>
                  ...
                  <tr>
                      ...
                      <td>
                          <textarea name="warning_address" style="width: 300px; height: 100px" >{/$warning_address/}</textarea><br>
                  ...
                  <tr>
                      ...
                      <td>
                          <textarea name="mail_comments" style="width: 300px; height: 100px" >{/$comments/}</textarea><br>
                          邮件注释位置：
                          <select style="width: 100px;height: 30px" name="comments_place">
                              <option value = '1'{/if $type eq '1'/}selected="selected" {//if/} >邮件顶端</option>
                              <option value = '2'{/if $type eq '2'/}selected="selected" {//if/} >邮件底部</option>
                          </select>
                      </td>
                  </tr>
              </table>
...
<script type="text/javascript">
    $("body").on("click",'.updateMail',function(){
        ...
        mailInfo.time = $("#content").find('select[name=hour]').val()+":"+ $("#content").find('select[name=minute]').val();
