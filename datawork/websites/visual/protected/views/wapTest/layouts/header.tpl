...
<body>
{/if $allcontent eq '' /}
  <nav id="header_hidden" class="navbar navbar-inverse navbar-fixed-top" style='position:relative;width:100%;margin-bottom:0px;background:#ffffff;display:none;' role="navigation">
    <div class="container-fluid ">
      ...
      <div class="navbar-collapse" style="margin-right: 0\9 ">
        <ul class="nav navbar-nav navbar-left" style="width:150px; float:left;left:3.1rem;z-index: 999;">
            <li><a class="web-title" href="/visual/index">趣店数据分析平台</a></li>
        </ul>
