<script src="/assets/lib/wapTest/moment.min.js"></script>
<script src="/assets/lib/wapTest/bootstrap-daterangepicker-slider/daterangepicker.js"></script>
<link href="/assets/lib/wapTest/bootstrap-daterangepicker-slider/daterangepicker-bs2.css" rel="stylesheet" />
<style type="text/css">
...
<script id ='searchtmpl' type='text/x-dot-template'>
    ...
    <div class="navbar navbar-default timebar three-mnue" role="navigation">
      <div class='row search_style'   style='width:99.9%%;padding:0px; margin:1px'>
          ...
          <div class='timestyle max-hide' style='padding-left:5px'>
            <div  class='btn-group'>
                {{~it.timereport.shortcut:shortlist:key }} 
                    {{? shortlist == 1}}
                     <a class='btn btn-default btn-xs  btn-special' data-option='{{=shortlist}}'>昨天</a>
                    {{?? shortlist == 2}}
                     <a class='btn btn-default  btn-xs btn-special' data-option='{{=shortlist}}'>前天</a>
                     {{??}}
        ...
        {{  }else{ }}
             <div class='timestyle'>
                ...
                <input name='startTime' <input name='endTime' type=
                 ...
                 {{ } else if(it.timereport.dateview_type == "3"){ }} 'month'
                 {{ } else { }}'date' {{ } }}
                 {{ } else { }}'text' readonly {{ } }} class='form-control  datepicker inputlist big-input' value＝""/>
             </div>
             <div class='timestyle'>
        ...
        {{ } }}
        <div style='padding-top:8px' class="search-rightbox max-hide">
            ...
            <a class='collnet pull-right showinfo' data-toggle="tooltip"  title='报表负责人' target='_blank'  style='color:#333;text-decoration:none'  href='http://speed.meilishuo.com/contacts/?q={{=it.basereport.author}}'>
            ...
            {{ } }}
            <span class='collnet collclick pull-right' data-id='{/$confArr.id/}' >
                {/if $menu_id eq 0 &&  $general eq ''  && $isCollect neq 1 /}
                <i class='glyphicon glyphicon-star-empty'></i><span>收藏</span>
              {/else if $isCollect  eq  1 /}
