...
class CDbCommand extends CComponent
{
	...
	public function execute($params=array())
	{
		...
		try
		{
            ...
            $t2=microtime(true);
            $t=round($t2-$t1,3);
		Yii::log('spend time:'.$t.' Executing SQL: '.$this->getText().$par,'info','system.db.CDbCommand');
			return $n;
		}
		catch(Exception $e)
		{
	...
	private function queryInternal($method,$mode,$params=array())
	{
        ...
        $t2=microtime(true);
        $t=round($t2-$t1,3);
		Yii::trace('spend time:'.$t.' Querying SQL: '.$this->getText().$par,'system.db.CDbCommand');
			return $result;
		}
		catch(Exception $e)
		{
